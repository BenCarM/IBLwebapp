...
<body>
    <div class="main">
        <form id="skinQuiz">
            <div class="question">
                Dryness and Tightness (Pick one)
            </div>
            <div class="choices">
                ...
                <label class="checkbox-cont">
                    ...
                    Skin still feels oily or greasy even after washing
                </label>
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="combination">
                    Certain areas of the face feel tight while others feel normal or oily
                </label>
                
            </div>
            <div class="row1">
                <a href="{{ url('/quiz3') }}" class="next-button">NEXT</a>
            </div>
        </form>
    </div>
