...
<body>
    <div class="main">
        <form id="skinQuiz">
            <div class="question">
                Pore Size and Appearance (Pick one)

            </div>
            <div class="choices">
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="dry">
                    Pores are small and barely visible across the face
                </label>
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="combination">
                    Pores are more noticeable in the T-zone than in other areas
                </label>
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="oily">
                    Pores are large and visible, especially around the nose and forehead
                </label>
                
                
            </div>
            <div class="row1">
                <a href="{{ url('/quiz4') }}" class="next-button">NEXT</a>
            </div>
        </form>
    </div>
