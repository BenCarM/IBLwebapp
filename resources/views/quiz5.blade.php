...
<body>
    <div class="main">
        <form id="skinQuiz">
            <div class="question">
                Environmental Sensitivity (Pick one)
            </div>
            <div class="choices">
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="dry">
                    Skin becomes very dry and tight in cold weather or air-conditioned environments
                </label>
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="combination">
                    Skin becomes dry in some areas and oily in others depending on the environment or season
                </label>
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="oily">
                    Skin stays oily regardless of the weather or environment
                </label>
                
                
            </div>
            <div class="row1">
                <button type="button" class="next-button" onclick="calculateSkinType()">COMPUTE</button>
            </div>
        </form>
    </div>
