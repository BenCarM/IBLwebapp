...
<body>
    <div class="main">
        <form id="skinQuiz">
            <div class="question">
                Shine and Oil production (Pick one)
            </div>
            <div class="choices">
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="dry">
                    Skin becomes dry and tight by midday
                </label>
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="oily">
                    Skin tends to get shiny or oily, particularly in the T-zone, by midday
                </label>
                <label class="checkbox-cont">
                    <input class="checkbox" type="checkbox" name="q1" value="combination">
                    Some areas of the face, like the T-zone, get oily while others stay dry or normal
                </label>
                
            </div>
            <div class="row1">
                <a href="{{ url('/quiz2') }}" class="next-button">NEXT</a>
